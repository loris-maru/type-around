  ...
  return (
    <div ref={dropdownRef} className={cn("relative", className)}>
      <button
        ...
        className={cn(
          "flex items-center gap-6 px-4 py-3 border rounded-lg text-sm font-whisper font-medium transition-colors",
          isOpen
        ...
        <div className="absolute z-50 right-0 mt-1 min-w-full bg-white border border-neutral-200 rounded-lg shadow-lg overflow-hidden">
          {options.map((option) => (
            <button
              ...
              className={cn(
                "w-full px-6 py-2 text-left text-sm font-whisper transition-colors whitespace-nowrap",
                option.value === value
