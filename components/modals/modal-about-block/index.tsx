...
export default function AboutBlockModal({
  ...
  const [marginTop, setMarginTop] = useState(
    initialData?.marginTop || ""
  );
  const [marginRight, setMarginRight] = useState(
    initialData?.marginRight || ""
  );
  const [marginBottom, setMarginBottom] = useState(
    initialData?.marginBottom || ""
  );
  const [marginLeft, setMarginLeft] = useState(
    initialData?.marginLeft || ""
  );
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-300 px-3 py-2 font-whisper text-sm"
                />
              </div>
              <div>
                <label
                  htmlFor="about-margin-right"
                  className="mb-1 block font-whisper text-neutral-600 text-xs"
                >
                  Right
                </label>
                <input
                  id="about-margin-right"
                  type="text"
                  value={marginRight}
                  onChange={(e) =>
              ...
              <div>
                <label
                  htmlFor="about-margin-bottom"
                  className="mb-1 block font-whisper text-neutral-600 text-xs"
                >
                  Bottom
                </label>
                <input
                  id="about-margin-bottom"
                  type="text"
                  value={marginBottom}
                  onChange={(e) =>
              ...
              <div>
                <label
                  htmlFor="about-margin-left"
                  className="mb-1 block font-whisper text-neutral-600 text-xs"
                >
                  Left
                </label>
                <input
                  id="about-margin-left"
                  type="text"
                  value={marginLeft}
                  onChange={(e) =>
