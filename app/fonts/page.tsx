...
export default async function FontsPage() {
  ...
  const mappedTypefaces: Array<{ studioName: string; typeface: Typeface }> =
    typefaces.map((t) => ({
      ...
      typeface: {
        ...
        icon: t.headerImage || "/mock/typefaces/icn_ortank.svg",
        fonts: t.fonts.map((f) => ({
          ...
          weight: f.weight,
          style: f.style || (f.isItalic ? "italic" : "normal"),
        })),
    ...
    return (
      <div className="relative w-full min-h-screen flex items-center justify-center px-10 py-32">
        <div className="text-center">
          <h1 className="text-3xl font-ortank font-bold mb-4">Fonts</h1>
  ...
  return (
    <div className="relative w-full px-10 py-32">
      <div className="mb-12">
        <h1 className="text-4xl font-ortank font-bold mb-4">All Fonts</h1>
        <p className="text-neutral-500 font-whisper">
          Discover {mappedTypefaces.length} typeface
          {mappedTypefaces.length !== 1 ? "s" : ""} from our community of
          designers.
        </p>
      </div>
